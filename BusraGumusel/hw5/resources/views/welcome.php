...
<div class="col-xs-6 col-xs-offset-3" ng-if="notify" ng-controller="UserController">
    <p class="bg-success text-success alert-dismissable">
...
<div class="pull-left col-xs-12 col-md-3" ng-controller="UserController">
    <div class="col-xs-12">
        <div class="panel panel-default">
            <div class="panel-heading" role="tab" id="headUser">
                <h4 class="panel-title">
                    <a role="button" data-toggle="collapse" target="_self" data-parent="#accordion" href="#collapseUser" aria-expanded="true" aria-controls="collapseUser">
        ...
        <div class="panel panel-default">
            <div class="panel-heading" role="tab" id="headBasket">
                <h4 class="panel-title">
                    Yemek Sepetim
                    <i class="text-danger glyphicon glyphicon-trash pull-right"
                       data-placement="top" data-toggle="tooltip" ng-click="emptyBasket()" title="Sepeti Bosalt"></i>
                </h4>
                <div id="collapseBasket" role="tabpanel" aria-labelledby="headBasket">
                    <div class="panel-body">
                        ...
                        <div ng-if="basket.length > 0">
                            ...
                            <button class="btn btn-primary btn-block btn-sm" ng-click="postOrder(basket)">Sipariş Ver</button>
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript" src="controllers/userOrdersController.js"></script>
