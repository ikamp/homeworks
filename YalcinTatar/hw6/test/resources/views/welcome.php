...
<div class="alert alert-success alert-dismissable" ng-controller="UserController">
    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
    <strong>Success!</strong> Order is success.Redirecting...
       {{time}}
</div>
</div>
<div class="header">
    ...
    <div class="col-xs-12">
        ...
        <div class="panel panel-default">
            <div class="panel-heading" role="tab" id="headBasket">
                <h4 class="panel-title">
                    Yemek Sepetim <button class="pull-right"><i class="text-danger glyphicon glyphicon-trash pull-right" ng-click="emptyBasket()" data-placement="left" data-toggle="tooltip" title="Sepeti Bosalt"></i></button>
                </h4>
            </div>
